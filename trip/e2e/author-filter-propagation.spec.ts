...
const NO_FILTER_BASELINE = {
  ...
  stripLabel: 'Tuesday, December 15, 5 activities, Kathmandu',
  monthDots: 3,
  monthLabel: 'Tuesday, December 15, 2026, 5 activities planned, Kathmandu',
  mapTotalAttr: '5',
...
test.describe('S383 — NON-REGRESSION: no filter selected means nothing changed', () => {
  ...
  test('the SHIPPED itinerary renders /plan unchanged — and shows no filter control at all', async ({
    ...
    expect(snap).toEqual({
      ...
      clashIds: [],
      stripLabel: 'Wednesday, December 9, 3 activities, New York, travel day',
      monthDots: 3,
      monthLabel: 'Wednesday, December 9, 2026, 3 activities planned, New York, travel day',
      mapTotalAttr: null,
      mapCountText: null,
      spanBandIds: [],
      emptyStateCopy: null,
