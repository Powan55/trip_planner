...
export interface ItineraryItem {
  ...
  // stays valid with all three absent). See core/sync/{hlc,merge-day}.ts. Stamped by the store
  // mutators when sync is on (core/sync/stamp.ts), and defaulted losslessly at the Vault v3→v4
  // migration / read boundary.
