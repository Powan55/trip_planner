...
current 7), add its coordinates to `lib/weather.ts` `CITY_COORDS`. The validator's
weather-known-city invariant fails loudly until you do. `TRIP_CITIES` picks up the new city
automatically.
