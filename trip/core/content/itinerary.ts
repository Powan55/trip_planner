...
export const TRIP_ITINERARY: DayPlan[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'j1-2', title: 'Fly Guangzhou (CAN) → Tokyo Haneda (HND) — China Southern 385', category: 'transportation', time: '08:50', duration: '3h 45m', notes: 'CAN T2 → HND Terminal 3 · China Southern 385 · arrives 1:35pm · Economy. Fill out Visit Japan Web before landing', location: 'Guangzhou (CAN T2) → Tokyo Haneda (HND T3)', tzOffsetMin: 480 },
