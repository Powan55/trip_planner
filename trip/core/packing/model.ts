...
export const DEFAULT_TEMPLATE: readonly PackingItem[] = [
  ...
  // one carrier flags for Jan 2027 is deliberately left out until it is more than a maybe.
  { id: 'universal-power-bank', label: "Portable battery pack — carry-on only, never checked; under 100 Wh (100-160 Wh needs airline approval, 2 max); don't use or charge it in flight", category: 'universal', checked: false },
  // ── Nepal leg ─────────────────────────────────────────────────────────────
