...
//
// The middle one is a gap D-418 left open. filesScanned counts up before the regex runs, the
...
// which is the state this whole audit was filed for. Two live sites is the floor; if the last
// one is ever genuinely removed, delete this guard in the commit that removes it and say so there.
if (filesScanned === 0) {
