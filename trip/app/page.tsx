...
/** Reserved height of the sticky section nav. Declared ONCE — the same rule as TRIP_STRIP_H
 *  and its other neighbours: the `loading:` slot here and the `<LazyVisible minHeight>` at the
 *  call site must never drift apart, or the chunk-fetch gap resizes the reserved box. */
...
// Declared ONCE, the same rule the named constants above carry: the `loading:` slot here and
// the `<LazyVisible minHeight>` at the call site must never drift apart.
